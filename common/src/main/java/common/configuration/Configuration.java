...
public class Configuration {
    ...
    public Configuration(long seed, Experiment e) throws IOException {
        ...
        tmanConfiguration = new TManConfiguration(seed, 300, 1);
        cyclonConfiguration = new CyclonConfiguration(seed, 5, 10, 300, 500000,(long) (Integer.MAX_VALUE - Integer.MIN_VALUE), 20);
